(function (global, factory) {
    ...
    const chatInit = () => {
        const {getData: e} = window.phoenix.utils, t = ".chat-sidebar", a = ".chat-textarea", c = "[data-chat-thread]",
            o = "[data-chat-thread-tab]", r = "[data-chat-thread-tab-content]", s = document.querySelector(t),
            l = document.querySelector(a), n = document.querySelectorAll(c), d = document.querySelector(o),
    ...
    const isotopeInit = () => {
        const {getData: e} = window.phoenix.utils, t = ".isotope-item", o = "[data-sl-isotope]", l = "[data-filter]",
            a = "[data-filter-nav]", r = "[data-gallery-column]", s = "sl-isotope", n = "active";
        if (window.Isotope) {
            const c = document.querySelectorAll(o), i = document.querySelector(r);
            c.length && c.forEach((o => {
                window.imagesLoaded(o, (() => {
                    document.querySelectorAll(t).forEach((e => {
                        e.style.visibility = "visible";
                    }));
                    const r = e(o, s), c = {itemSelector: t, layoutMode: "packery"}, d = window._.merge(c, r),
                        u = new window.Isotope(o, d), m = (e = 4) => {
                            for (let t = 1; t < e; t += 1) {
                    ...
                    return document.querySelector(a)?.addEventListener("click", (e => {
                        ...
                        u.arrange({filter: t}), document.querySelectorAll(l).forEach((e => {
    ...
    const handleNavbarVerticalCollapsed = () => {
        const {getItemFromStore: e, setItemToStore: t, resize: a} = window.phoenix.utils, o = "body",
            ...
            c = ".navbar-vertical .nav-link.active", s = "click", i = "navbar.vertical.toggle",
    ...
    const swiperInit = () => {
        ...
        t && t.forEach((t => {
            const r = t.querySelector("[data-swiper]"), i = e(r, "swiper"), n = i.thumb;
            let s;
            if (n) {
    ...
    const themeControl = () => {
        const {getData: e, getItemFromStore: t, getSystemTheme: a} = window.phoenix.utils, o = t => {
            ...
            }, r = new DomNode(document.body), n = document.querySelector(".navbar-vertical"),
            c = document.querySelector(".navbar-top"), i = document.querySelector(".support-chat-container");
        initialDomSetup(r.node), r.on("click", (e => {
            ...
            if (d.data("theme-control")) {
                ...
                switch ("phoenixTheme" === l && "boolean" == typeof h && (h = h ? "dark" : "light"), config.hasOwnProperty(l) && window.config.set({[l]: h}), l) {
                    case"phoenixTheme": {
                    ...
                    case"phoenixNavbarVerticalStyle":
                        n.setAttribute("data-navbar-appearance", "default"), "default" !== h && n.setAttribute("data-navbar-appearance", "darker");
                        break;
    ...
    const wizardInit = () => {
        const {getData: e} = window.phoenix.utils, t = "[data-theme-wizard]", a = "[data-wizard-step]",
            d = "[data-wizard-form]", s = "[data-wizard-password]", r = "[data-wizard-confirm-password]",
            l = "[data-wizard-next-btn]", o = "[data-wizard-prev-btn]", n = "[data-wizard-footer]", i = "submit",
            c = "show.bs.tab", u = "shown.bs.tab", w = "click";
        document.querySelectorAll(t).forEach((t => {
            const b = t.querySelectorAll(a), h = t.querySelectorAll(d), m = t.querySelector(s), v = t.querySelector(r),
                f = t.querySelector(l), p = t.querySelector(o), L = t.querySelector(n),
                y = new Event(i, {bubbles: !0, cancelable: !0}), z = t.hasAttribute("data-wizard-modal-disabled"),
    ...
    const towFAVerificarionInit = () => {
        const e = document.querySelector("[data-2fa-form]"), t = e?.querySelectorAll("input[type=number]"),
    ...
    const mapboxInit = () => {
        const {getData: e} = window.phoenix.utils, o = document.querySelectorAll(".mapbox-container"),
        ...
        o && o.forEach((o => {
            ...
            if (n) {
                const o = e(n, "mapbox"), r = document.querySelector(".zoomIn"), a = document.querySelector(".zoomOut"),
                    l = document.querySelector(".fullScreen"), c = {
                ...
                o.center && new window.mapboxgl.Marker({color: getColor("danger")}).setLngLat(o.center).addTo(m), r && a && (r.addEventListener("click", (() => m.zoomIn())), a.addEventListener("click", (() => m.zoomOut()))), l && l.addEventListener("click", (() => m.getContainer().requestFullscreen())), t.forEach((e => {
    ...
    const flightMapInit = () => {
        if (document.querySelector("#flightMap")) {
            window.mapboxgl.accessToken = "pk.eyJ1IjoidGhlbWV3YWdvbiIsImEiOiJjbGhmNW5ybzkxcmoxM2RvN2RmbW1nZW90In0.hGIvQ890TYkZ948MVrsMIQ";
            const e = document.querySelector(".zoomIn"), t = document.querySelector(".zoomOut"),
                o = document.querySelector(".fullScreen"), r = {
                    default: "mapbox://styles/mapbox/light-v11",
                    light: "mapbox://styles/themewagon/clj57pads001701qo25756jtw",
                    dark: "mapbox://styles/themewagon/cljzg9juf007x01pk1bepfgew"
            ...
            const a = [-61.100583, 5.044713], i = [-74.2139449434892, 8.136553550752552], l = [-84.913785, 10.325774],
                s = {
                    type: "FeatureCollection",
                    features: [{type: "Feature", geometry: {type: "LineString", coordinates: [a, i]}}]
                }, c = {
                    type: "FeatureCollection",
                    features: [{type: "Feature", geometry: {type: "LineString", coordinates: [i, l]}}]
                };
            let d = 1;
            ({
                type: "FeatureCollection",
            ...
            const u = window.turf.length(s.features[0]), p = window.turf.length(s.features[0]), m = [], g = [], y = 500;
            ...
            s.features[0].geometry.coordinates = m, c.features[0].geometry.coordinates = g, n.on("load", (() => {
                n.addSource("route", {type: "geojson", data: s.features[0]}), n.addSource("route2", {
                    type: "geojson",
                    data: c.features[0]
                }), n.addLayer({
                    id: "route",
    ...
    const priceTierFormInit = () => {
        ...
        e && e.forEach((e => {
            const t = e.querySelector("[data-price-toggle]"), r = e.querySelectorAll("[data-pricing]"),
                a = e.querySelector("[data-pricing-collapse]"), c = new window.bootstrap.Collapse(a, {toggle: !1});
    ...
    const nouisliderInit = () => {
        ...
        if (window.noUiSlider) {
            document.querySelectorAll("[data-nouislider]").forEach((t => {
                const e = n(t, "nouislider"), o = n(t, "nouislider-values");
                let i;
                i = o && o.length ? {
                    connect: !0,
                    step: 1,
    ...
    const collapseAllInit = () => {
        const e = document.querySelector("[data-collapse-all]"), l = document.querySelector("[data-btn-collapse-all]");
        if (e) {
    ...
    const {L: L} = window, leafletInit = () => {
        ...
        if (L && e) {
            const e = () => "dark" === window.config.config.phoenixTheme ? ["invert:98%", "grayscale:69%", "bright:89%", "contrast:111%", "hue:205deg", "saturate:1000%"] : ["bright:101%", "contrast:101%", "hue:23deg", "saturate:225%"],
                ...
                o = L.map("map", {center: L.latLng(25.659195, 30.182691), zoom: .6, layers: [a], minZoom: 1.4}),
        ...
        e && e.forEach((() => {
            ...
            e.on("load", (() => {
                e.addSource("earthquakes", {
                    ...
                    const o = e.queryRenderedFeatures(t.point, {layers: ["clusters"]}), r = o[0].properties.cluster_id;
                    ...
                    const o = t.features[0].geometry.coordinates.slice(), {mag: r} = t.features[0].properties,
    ...
    const {echarts: echarts} = window, tripReviewChartInit = () => {
        const {getData: t, getColor: o} = window.phoenix.utils, e = document.querySelectorAll(".echart-trip-review");
        e && e.forEach((e => {
            const i = t(e, "options"), r = echarts.init(e);
            echartSetOption(r, i, (() => ({
                tooltip: {
                    trigger: "item",
                    padding: [7, 10],
    ...
    const passwordToggleInit = () => {
        ...
        t && t.forEach((t => {
            const s = t.querySelector("[data-password-input]"), e = t.querySelector("[data-password-toggle]");
            e.addEventListener("click", (() => {
    ...
    window.initMap = initMap, docReady(detectorInit), docReady(simplebarInit), docReady(toastInit), docReady(tooltipInit), docReady(featherIconsInit), docReady(basicEchartsInit), docReady(bulkSelectInit), docReady(listInit), docReady(anchorJSInit), docReady(popoverInit), docReady(formValidationInit), docReady(docComponentInit), docReady(swiperInit), docReady(productDetailsInit), docReady(ratingInit), docReady(quantityInit), docReady(dropzoneInit), docReady(choicesInit), docReady(tinymceInit), docReady(responsiveNavItemsInit), docReady(flatpickrInit), docReady(iconCopiedInit), docReady(isotopeInit), docReady(bigPictureInit), docReady(countupInit), docReady(phoenixOffcanvasInit), docReady(todoOffcanvasInit), docReady(wizardInit), docReady(reportsDetailsChartInit), docReady(glightboxInit), docReady(themeControl), docReady(searchInit), docReady(handleNavbarVerticalCollapsed), docReady(navbarInit), docReady(navbarComboInit), docReady(fullCalendarInit), docReady(picmoInit), docReady(chatInit), docReady(modalInit), docReady(lottieInit), docReady(navbarShadowOnScrollInit), docReady(dropdownOnHover), docReady(supportChatInit), docReady(sortableInit), docReady(copyLink), docReady(randomColorInit), docReady(faqTabInit), docReady(createBoardInit), docReady(advanceAjaxTableInit), docReady(kanbanInit), docReady(towFAVerificarionInit), docReady(mapboxInit), docReady(flightMapInit), docReady(typedTextInit), docReady(priceTierFormInit), docReady(nouisliderInit), docReady(collapseAllInit), docReady(leafletInit), docReady(mapboxClusterInit), docReady(tripReviewChartInit), docReady(playOnHoverInit), docReady(passwordToggleInit), docReady((() => {
        const t = document.querySelector("[data-selected-rows]"), e = document.getElementById("selectedRows");
        if (t) {
            const o = document.getElementById("bulk-select-example"), i = window.phoenix.BulkSelect.getInstance(o);
            t.addEventListener("click", (() => {
